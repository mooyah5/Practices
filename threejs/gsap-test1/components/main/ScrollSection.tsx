        ...
        >
          ...
          >
            <div
              ...
              className="w-full h-full flex flex-col gap-16 p-[5%] text-white"
            >
              <div>
              ...
              <div className="aspect-square bg-gray-50 bg-opacity-30">
                이미지
              </div>
            ...
            <div className="w-full h-full p-[5%] py-[10%]">
              <div className="bg-white bg-opacity-70 p-10 w-full h-full flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    {/* 아치 프로젝트는 창의적인 예술가들을 위한 공간으로 여정을
                  시작했습니다. 예술을 사랑하는 사람들이 모여 개인의 역량을 발할
                  수 있는 기회를 제공합니다. */}
                  </div>
                  <div
                    id="text-section04-3"
                    className="w-full font-light text-[0.9vw]"
                  >
                    {/* 뿐만 아니라 아치 안에서 다양한 예술층을 위한 기회의 장을
                  만들어냅니다. 아치를 통해 예술과 기업이 만나 새로운 가치를
                  창출하며, 더욱 풍요로운 예술 경험을 선사합니다. 아치와 함께
                  새로운 여정을 함께해보세요. */}
                  </div>
